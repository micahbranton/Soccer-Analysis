...
ranges = [(0.001, 0.85), (0.12, 4.60), (0.001, 0.40), (0.001, 0.45),
          (0.001, 3.05), (0.01, 6.5), (30, 90), (0.1, 5.30), (0.1, 5.7),
...
radar.fill(player1_data, 'g', alpha=0.2)
radar.plot(player2_data, 'r')
radar.fill(player2_data, 'r', alpha=0.2)
plt.show()
