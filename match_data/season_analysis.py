...
shot_stats = team_stats[['team_name',
                         'goals_for',
                         'goals_against',
                         'totalshots_for',
                         'totalshots_against',
...
shot_stats['shot_accuracy_for'] = shot_stats[
    'shotsgoal_for'] / shot_stats['totalshots_for']

shot_stats['shot_accuracy_against'] = shot_stats[
    'shotsgoal_against'] / shot_stats['totalshots_against']

shot_stats['goal_conversion_for'] = shot_stats[
    'goals_for'] / shot_stats['shotsgoal_for']
...
stats_dict = {
    'goals_for': [
        ...
        'Top {0} de Equipos con más goles a favor'.format(
            teams_in_graph),
        False,
        1],
    'goals_against': [
        'es el que menos goles le convirtieron',
        'Top {0} de Equipos con menos goles en contra'.format(
            teams_in_graph),
        True,
        1],
    'totalshots_for': [
        'es el más tirador',
        'Top {0} de Equipos con más tiros a favor'.format(
            teams_in_graph),
        False,
        1],
    'totalshots_against': [
    ...
    'shotsgoal_against': [
        ...
        'Top {0} de Equipos que menos tiros al arco concedieron a sus rivales'.format(
            teams_in_graph),
        True,
        1],
    'tsr': [
        'es el más Dominador en Tiros Totales',
        'Top {0} de Equipos que más superan a sus rivales en ese ámbito'.format(
            teams_in_graph),
        False,
        1],
    'sotr': [
    ...
    'shot_accuracy_for': [
        ...
        'Top {0} de Equipos con mayor proporción de tiros al arco sobre tiros realizados'.format(
            teams_in_graph),
        False,
        100],
    'shot_accuracy_against': [
        'es el que menos tiros al arco recibe',
        'Top {0} de Equipos con menor proporción de tiros al arco sobre tiros recibidos'.format(
            teams_in_graph),
        True,
        100],
    'goal_conversion_for': [
        'tiene el ataque más efectivo',
        'Top {0} de Equipos con mayor proporción de goles convertidos sobre tiros al arco realizados'.format(
            teams_in_graph),
        False,
        100],
    'goal_conversion_against': [
        'tiene la defensa más efectiva',
        'Top {0} de Equipos con menor proporción de goles en contra sobre tiros al arco recibidos'.format(
            teams_in_graph),
        True,
        100],
}
